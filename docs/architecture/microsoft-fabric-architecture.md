...
Stores immutable raw telemetry and operational events generated by all simulator domains, including environmental monitoring, irrigation, equipment, crop lifecycle, maintenance, platform events, and alerts.
...
1. Python simulator generates environmental, irrigation, equipment, crop lifecycle, maintenance, platform, and alert events.
...
Operational telemetry and business events are generated by persistent simulator entities and processed through Eventstream and Eventhouse to enable near real-time monitoring, KQL analytics, operational dashboards, and automated alerting.
