...
WEATHER_SENSOR_ADJUSTMENTS: Final[
    ...
    WEATHER_PARTLY_CLOUDY: {
        SENSOR_TYPE_AIR_TEMPERATURE: 0.8,
        SENSOR_TYPE_HUMIDITY: -1.5,
        SENSOR_TYPE_LIGHT_INTENSITY: 2500.0,
    },
    WEATHER_CLOUDY: {
    ...
    WEATHER_THUNDERSTORM: {
        SENSOR_TYPE_AIR_TEMPERATURE: -3.5,
        SENSOR_TYPE_HUMIDITY: 12.0,
        SENSOR_TYPE_CO2: 15.0,
        SENSOR_TYPE_LIGHT_INTENSITY: -14000.0,
    },
    WEATHER_FOGGY: {
        SENSOR_TYPE_AIR_TEMPERATURE: -1.8,
        SENSOR_TYPE_HUMIDITY: 10.0,
        SENSOR_TYPE_LIGHT_INTENSITY: -10000.0,
    },
}
